...
#         self.load_model()
    ...
    def load_model(self,model_path,device,DYN_BATCH_ENABLED=False,max_batch_dyn=10):
        """
        ...
        self.batch_size, self.channel, self.height, self.width = self.net.input_info[self.input_blob].tensor_desc.dims
