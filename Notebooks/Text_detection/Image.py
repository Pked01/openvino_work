...
def decode_predictions(scores, geometry):
    ...
    for y in range(0, numRows):
        ...
        # coordinates that surround text6
...
image = "/Users/20widyatmodjok/Downloads/untitledfolder/maxresdefault.jpg"
img= cv.imread(image)
orig = img.copy()
...
img = cv.dnn.blobFromImage(img,1, (320,320))
...
for ((startX, startY, endX, endY), text) in results:
    ...
    cv.putText(output, text, (startX, startY - 20), cv.FONT_HERSHEY_SIMPLEX, 1.2, (0, 0, 255), 3)
